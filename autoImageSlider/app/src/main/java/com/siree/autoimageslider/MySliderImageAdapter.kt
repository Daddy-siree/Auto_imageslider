package com.siree.autoimageslider
...
class MySliderImageAdapter() :  SliderViewAdapter<MySliderImageAdapter.VH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?): MySliderImageAdapter.VH {
        val inflate: View =
            LayoutInflater.from(parent!!.context).inflate(R.layout.image_holder, null)
        return VH(inflate)
    }

    override fun onBindViewHolder(viewHolder: MySliderImageAdapter.VH?, position: Int) {
